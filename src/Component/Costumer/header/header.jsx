...
export default function Header() {
  ...
  const handlProfile = () => {
    ...
    // window.location("/Information/user")
  };
  ...
  return (
    <Box sx={{ flexGrow: 1, color: "#e6e6e7" }}>
      <AppBar position="static">
        <Toolbar>
          ...
          >
           <NavLink to="/User/home" style={{ color: "white" }}>Home</NavLink> 
          </Typography>
          <Typography
            variant="h6"
            noWrap
            ...
            sx={{ display: { xs: "none", sm: "block", marginRight: "10px" } }}
          >
            <NavLink to="/Costumer/Offers" style={{ color: "white" }}>
              Offers
            </NavLink>
          </Typography>
          <Search>
